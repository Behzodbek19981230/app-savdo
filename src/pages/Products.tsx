										...
										{products.map((product, index) => (
											<TableRow key={product.id}>
												<TableCell className='py-1'>
													<Avatar
														className='h-9 w-10 cursor-pointer hover:opacity-80 transition-opacity'
														onClick={async () => {
				...
				<DialogContent className='w-[90vw] max-w-lg'>
						...
						<div className='flex items-center gap-3'>
							...
							<div>
								...
								<DialogDescription className='truncate'>
									{stockProduct
										? `${stockProduct.model_detail?.name || stockProduct.id} • ${
												stockProduct.branch_detail?.name || ''
											}`
										: ''}
								</DialogDescription>
					...
					<div className='py-3'>
						{stockLoading ? (
							...
							<div className='flex flex-col items-center justify-center py-8 text-center'>
								<Package className='h-9 w-10 text-muted-foreground/60 mb-3' />
								...
								{stockItems.map((s) => (
									...
									>
										<div className='flex items-start gap-3'>
											<div className='h-9 w-9 rounded bg-muted/60 flex items-center justify-center text-sm font-medium'>
				...
				<DialogContent className='w-[95vw] max-w-[800px] max-h-[90vh] overflow-y-auto'>
					...
					{editingId && isProductByIdLoading ? (
						<div className='flex items-center justify-center py-12'>
							<Loader2 className='h-9 w-10 animate-spin text-muted-foreground' />
						</div>
					) : (
						<Form {...form}>
							<form
