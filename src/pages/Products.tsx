                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <div>
                                ...
                                <DialogDescription className='truncate'>
                                    {stockProduct
                                        ? `${stockProduct.model_detail?.name || stockProduct.id} • ${stockProduct.branch_detail?.name || ''
                                        }`
                                        : ''}
                                </DialogDescription>
                    ...
                    <div className='py-3'>
                        {stockLoading ? (
                            ...
                            <div className='flex flex-col items-center justify-center py-8 text-center'>
                                ...
                                <p className='text-sm text-muted-foreground'>Ombor ma'lumotlari topilmadi</p>
                            </div>
                        ) : (
                                ...
                                {stockItems.map((s) => (
                                    ...
                                    >
                                        <div className='flex items-start gap-3'>
                                            <div className='h-7 w-9 rounded bg-muted/60 flex items-center justify-center text-sm font-medium'>
                                        ...
                                        <div className='flex items-center gap-3'>
                                            <div className='text-sm text-muted-foreground'>Miqdori</div>
