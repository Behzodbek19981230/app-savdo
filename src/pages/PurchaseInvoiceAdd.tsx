...
export default function PurchaseInvoiceAdd() {
    ...
    const checkSkladStock = async () => {
        ...
        productForm.setValue('real_price', Number(product?.real_price ?? 0));

        if (invoiceType !== PurchaseInvoiceType.INTERNAL || !selectedSkladId) {
            setSkladStockCount(null);
            return;
        }
        if (!product) {
            setSkladStockCount(0);
                                            ...
                                            <div className='flex'>
                                                <FormControl>
                                                    <Input
                                                        ...
                                                        className={`rounded-r-none ${invoiceType === PurchaseInvoiceType.INTERNAL &&
                                                            skladStockCount !== null &&
