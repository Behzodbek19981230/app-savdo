...
export function OrderShowPage() {
    ...
    const totalPaidUSD = Number(order_history.summa_total_dollar || 0);
    const totalProfitUSD = Number(order_history.all_profit_dollar || 0);
            ...
            <div className='bg-white dark:bg-card rounded-lg shadow-md dark:shadow-md border border-border p-3 sm:p-4 mb-4'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3'>
                        ...
                        return (
                            <div className='bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-500/20 dark:to-blue-500/20 p-2 rounded border-2 border-indigo-300 dark:border-indigo-500/30'>
                                ...
                                <p className='font-bold text-indigo-700 dark:text-indigo-300 text-base mb-0.5'>
                                    {formatNumber(payableUSD)} USD
                                </p>
                                <p className='text-xs font-semibold text-indigo-600 dark:text-indigo-300'>
                                    {formatNumber(Number(order_history.summa_total_dollar || 0) * usdRate)} UZS
                                </p>
                            </div>
                        );
                    })()}
                    ...
                    <div className='bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-500/20 dark:to-blue-500/20 p-2 rounded border-2 border-indigo-300 dark:border-indigo-500/30'>
                        ...
                        <p className='font-bold text-indigo-700 dark:text-indigo-300 text-base mb-0.5'>
                            {formatNumber(Number(order_history.summa_total_dollar || 0))} USD
                        </p>
                        <p className='text-xs font-semibold text-indigo-600 dark:text-indigo-300'>
                            {formatNumber(Number(order_history.summa_total_dollar || 0) * usdRate)} UZS
                        </p>
                    ...
                    <div className='bg-gradient-to-br from-rose-50 to-red-50 dark:from-rose-500/20 dark:to-red-500/20 p-2 rounded border border-rose-200 dark:border-rose-500/30'>
                        ...
                        <p className='font-bold text-rose-700 dark:text-rose-300 text-base mb-0.5'>
                            {formatNumber(Number(order_history.discount_amount || 0))} USD
                        </p>
                        <p className='text-xs font-semibold text-rose-600 dark:text-rose-400'>
                            {formatNumber(Number(order_history.discount_amount || 0) * usdRate)} UZS
                        </p>
                    </div>
                    ...
                    {(() => {
                        ...
                        return (
                            <div className='bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-500/20 dark:to-pink-500/20 p-2 rounded border border-red-200 dark:border-red-500/30'>
                                <p className='text-[10px] font-semibold text-red-600 dark:text-red-400 mb-1 uppercase tracking-wide'>
                                    Qolgan qarz ($)
                                </p>
                                <p className='font-bold text-red-700 dark:text-red-300 text-base mb-0.5'>
                                    {formatNumber(Number(order_history.total_debt_client || 0))} USD
                                </p>
                                <p className='text-xs font-semibold text-red-600 dark:text-red-300'>
                                    {formatNumber(Number(order_history.total_debt_client || 0) * usdRate)} UZS
                                </p>
                            </div>
                        );
                    })()}
                    ...
                    {/* Umumiy foyda */}
                    {(roles.isAdmin || roles.isSuperAdmin) && <div className='bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-500/20 dark:to-green-500/20 p-2 rounded border-2 border-emerald-300 dark:border-emerald-500/30'>
                        ...
                        <p className='font-bold text-emerald-700 dark:text-emerald-300 text-base mb-0.5'>
                            {formatNumber(Number(order_history.all_profit_dollar || 0))} USD
                        </p>
                        <p className='text-xs font-semibold text-emerald-600 dark:text-emerald-300'>
                            {formatNumber(Number(order_history.all_profit_dollar || 0) * usdRate)} UZS
                        </p>
                    </div>}
                </div>
                ...
                <div className='mt-2 col-span-2'>
                    ...
                    {(Number(order_history.zdacha_dollar || 0) > 0 || Number(order_history.zdacha_som || 0) > 0) && (
                        <div className='bg-gradient-to-br from-yellow-50 to-amber-50 dark:bg-muted/50 p-2 rounded border border-yellow-200 dark:border-border'>
                ...
                <div className='mt-2 grid grid-cols-2 gap-2'>
                    {/* Izoh */}
                    {order_history.note && (
                        <div className='bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-500/20 dark:to-gray-500/20 p-2 rounded border border-slate-200 dark:border-slate-500/30'>
                    ...
                    {order_history.driver_info && (
                        <div className='bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-500/20 dark:to-cyan-500/20 p-2 rounded border border-teal-200 dark:border-teal-500/30'>
