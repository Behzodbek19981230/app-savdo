...
export function OrderShowPage() {
    ...
    return (
        <div ref={printRef} className='h-full overflow-y-auto p-4 sm:p-6'>
                    ...
                    <div className='bg-gradient-to-br from-gray-50 to-slate-50 dark:from-gray-500/20 dark:to-slate-500/20 p-2 rounded border border-gray-200 dark:border-gray-500/30'>
                        ...
                        <div className='space-y-0.5'>
                            <div className='flex items-center gap-1.5'>
                                <span
                                    className={`w-1.5 h-1.5 rounded-full ${order_history.status_order_dukon
                                        ? 'bg-green-500'
                            ...
                            <div className='flex items-center gap-1.5'>
                                <span
                                    className={`w-1.5 h-1.5 rounded-full ${order_history.status_order_sklad
                                        ? 'bg-green-500'
                                        : 'bg-gray-300 dark:bg-gray-600'
                                        }`}
                                ></span>
            ...
            {products.length > 0 && <div className='bg-white dark:bg-card rounded-lg shadow-md dark:shadow-md border border-border overflow-hidden'>
