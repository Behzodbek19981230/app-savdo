...
import { ArrowDown, ArrowUp, ArrowUpDown, Edit, Loader2, Pencil, Plus, Search, Trash2, Users } from 'lucide-react';
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder='F.I.Sh' className='h-7' {...field} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
										...
										<FormItem>
											...
											<FormControl>
												<Autocomplete
													...
													onValueChange={(v) => field.onChange(v === 'none' ? '' : String(v))}
													placeholder='Tanlang'
													className='h-7'
												/>
											</FormControl>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input type='number' step='0.01' className='h-7' {...field} />
											</FormControl>
											<FormMessage />
										</FormItem>
									)}
											...
											<FormControl>
												<Autocomplete
													options={[
														...
														{ value: 'dokon', label: 'Dokon' },
														{ value: 'hamkor', label: 'Hamkor' },
													]}
													value={field.value || undefined}
