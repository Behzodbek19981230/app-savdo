			...
			<Card>
				<CardHeader className='flex flex-row items-center justify-between flex-wrap gap-2'>
					...
					<div className='flex items-center gap-2'>
						...
						<Badge
							variant='default'
							className={`text-xs ${invoice.type === PurchaseInvoiceType.EXTERNAL ? 'bg-green-600' : 'bg-blue-600'}`}
						>
					...
					<>
						<div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-3'>
							...
							{invoice.type === PurchaseInvoiceType.INTERNAL ? (
								<>
									...
									<div className='flex items-baseline gap-1.5'>
										...
										<p className='font-medium text-xs'>{invoice.sklad_detail?.name || '-'}</p>
									</div>
								</>
							) : (
								<>
									...
									<div className='flex items-baseline gap-1.5'>
										...
										<p className='font-medium text-xs'>{invoice.supplier_detail?.name || '-'}</p>
									</div>
									<div className='flex items-baseline gap-1.5'>
							...
							<div className='flex items-baseline gap-1.5'>
								...
								<p className='font-medium text-xs'>{invoice.product_count} ta</p>
							</div>
							<div className='flex items-baseline gap-1.5'>
