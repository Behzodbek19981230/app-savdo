...
import { Search, ArrowUpDown, ArrowUp, ArrowDown, Plus, Pencil, Trash2, Loader2, Package, SearchIcon, X } from 'lucide-react';
				...
				<CardHeader className='flex flex-row items-center justify-between'>
					<div>
						<div className='flex items-center gap-2'>
							<Package className='h-5 w-5 txt-primary' />
							<CardTitle className='text-lg'>Mahsulot turlari</CardTitle>
						</div>
						<CardDescription>Jami {pagination?.total || 0} ta mahsulot turi (bo&apos;lim)</CardDescription>
					</div>
