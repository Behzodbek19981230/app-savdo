...
function SectionTitle({ children }: { children: React.ReactNode }) {
	return (
		<h3 className='text-xs font-semibold uppercase tracking-wider text-muted-foreground mt-6 mb-3 first:mt-0 border-b pb-2'>
			{children}
		</h3>
	);
}
		...
		<div className='space-y-8'>
			<div className='flex items-center justify-between'>
				<div className='flex items-center gap-4'>
					...
					<div>
						<h1 className='text-xl md:text-4xl font-bold tracking-tight'>Mahsulot</h1>
							...
							<Card className='relative overflow-hidden'>
								{imagesLoading ? (
									...
									<div className='h-[420px] flex flex-col items-center justify-center gap-3 text-center p-6'>
										<ImagePlus className='h-7 w-10 text-muted-foreground/60' />
										<div>
							...
							<div className='flex flex-col gap-4 min-h-0'>
								<Card className='p-4'>
									...
									{pending.length > 0 && (
										<div className='mt-3'>
											<div className='flex items-center justify-between'>
												<div className='text-xs text-muted-foreground'>Tanlangan fayllar</div>
											...
											<div className='mt-2 grid grid-cols-4 gap-2'>
												...
												{pending.length > 8 && (
													<div className='aspect-square rounded-md border flex items-center justify-center text-xs text-muted-foreground'>
														+{pending.length - 8}
													</div>
												)}
											</div>
												...
												return (
													...
													>
														...
														{editingId === img.id && (
															...
															>
																<label
																	className='w-full cursor-pointer rounded-md bg-background p-3 text-xs'
