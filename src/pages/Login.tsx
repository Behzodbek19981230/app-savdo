    ...
    return (
        <div className='min-h-screen flex items-center justify-center relative overflow-hidden p-4'>
            ...
            <div className='relative z-10  max-w-6xl  justify-center items-center'>
                ...
                <Card className='w-full  sm:w-[300px] md:w-[400px] lg:w-[500px] shadow-2xl border-border/50 backdrop-blur-sm bg-card/95 p-4 '>
                    <CardHeader className='space-y-1 text-center'>
                        <CardTitle className='text-xl lg:text-xl font-bold'>Tizimga kirish</CardTitle>
                    </CardHeader>
