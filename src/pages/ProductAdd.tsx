	...
	return (
		<div className='space-y-6'>
			<div className='flex items-center justify-between'>
				<div>
					<h1 className='text-xl font-bold tracking-tight'>Mahsulotlar qo'shish</h1>
					...
					<div className='space-y-4'>
						<div className='flex items-end gap-4'>
							<div className='flex-1'>
								<label className='text-xs font-medium mb-2 block'>Kategoriya *</label>
								<Autocomplete
									...
									onValueChange={(v) => handleCategoryChange(String(v))}
											...
											{isLoadingProducts ? (
												<TableRow>
													<TableCell colSpan={7} className='text-center py-8'>
														<Loader2 className='h-7 w-6 animate-spin mx-auto' />
													</TableCell>
												</TableRow>
											) : (
												<>
																	...
																	render={({ field }) => {
																		...
																		return (
																			<FormItem>
																				<FormControl>
																					<Autocomplete
																						options={filteredModelTypes.map(
																							(modelType) => ({
																								value: modelType.id,
																	...
																	render={({ field }) => {
																		...
																		return (
																			<FormItem>
																				<FormControl>
																					<Autocomplete
																						options={filteredModelSizes.map(
																							(modelSize) => ({
																								value: modelSize.id,
																								label: `${modelSize.size} — ${ModelSizeTypeLabels[modelSize.type]}`,
																							}),
																						)}
																						value={field.value || undefined}
																						onValueChange={(value) =>
