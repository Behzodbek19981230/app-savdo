...
export default function Units() {
    ...
    const isMutating =
        createUnit.isPending || updateUnit.isPending || deleteUnit.isPending;
            ...
            <Card>
                <CardHeader className="pb-4 flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Jami {pagination?.total || 0} ta o&apos;lchov birligi
                        </CardDescription>
                    </div>
                ...
                <DialogContent className="sm:max-w-[525px]">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            <DialogHeader>
                                <DialogTitle>
                                    {editingId ? 'Tahrirlash' : "Yangi birlik qo'shish"}
                                </DialogTitle>
                                <DialogDescription>
                                    O&apos;lchov birligi ma&apos;lumotlarini kiriting
                                </DialogDescription>
                            </DialogHeader>
