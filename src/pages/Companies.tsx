                                    ...
                                    <TableBody>
                                        {companies.map((c) => (
                                            <TableRow key={c.id}>
                                                ...
                                                <TableCell className="max-w-[220px] truncate">{getRegionName(c.region)}</TableCell>
                                                <TableCell className="max-w-[220px] truncate">{getDistrictName(c.district)}</TableCell>
