	...
	useEffect(() => {
		...
		if (sectionToOpen) {
			setOpenSections((prev) => {
				if (prev[sectionToOpen as string]) return prev;
				return { ...prev, [sectionToOpen as string]: true };
			});
		}
		if (itemToOpenKey) {
			setOpenItems((prev) => {
				if (prev[itemToOpenKey as string]) return prev;
				return { ...prev, [itemToOpenKey as string]: true };
			});
		}
