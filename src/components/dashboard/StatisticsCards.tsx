...
const baseCards = [
    ...
    },
    {
        ...
        // Existing view: SupplierAccount repayment tab
        href: '/supplier-account?tab=repayment',
    },
    {
        key: 'expense',
        title: 'Xarajatlar',
                    ...
                    <>
                            ...
                            {cards.map((card) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className='group relative bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-border cursor-pointer'
                                    >
                                        <div
                                        ...
                                        <div className='relative p-4'>
                                            <div className='flex items-center justify-between mb-3'>
                                                ...
                                                {card.key === 'income' && data?.debt_repayments?.discount && (
                                                    <div className='flex items-center bg-yellow-50/80 dark:bg-yellow-950/40 px-2 py-0.5 rounded-md border border-yellow-200/50 dark:border-yellow-800/40'>
                                                        <span className='text-[10px] font-semibold text-yellow-700 dark:text-yellow-400'>
                                                            {safeNum(data.debt_repayments.discount).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                            ...
                                            {card.key === 'sales' && data?.orders?.payments && (
                                                <>
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-green-50/60 dark:bg-green-950/30 rounded-lg border border-green-200/50 dark:border-green-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.orders.payments.cash).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-purple-50/60 dark:bg-purple-950/30 rounded-lg border border-purple-200/50 dark:border-purple-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.orders.payments.click).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-orange-50/60 dark:bg-orange-950/30 rounded-lg border border-orange-200/50 dark:border-orange-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.orders.payments.terminal).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-cyan-50/60 dark:bg-cyan-950/30 rounded-lg border border-cyan-200/50 dark:border-cyan-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.orders.payments.transfer).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                            ...
                                            {card.key === 'returns' && data?.vozvrat?.payments && (
                                                <>
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-green-50/60 dark:bg-green-950/30 rounded-lg border border-green-200/50 dark:border-green-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.vozvrat.payments.cash).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-purple-50/60 dark:bg-purple-950/30 rounded-lg border border-purple-200/50 dark:border-purple-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.vozvrat.payments.click).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-orange-50/60 dark:bg-orange-950/30 rounded-lg border border-orange-200/50 dark:border-orange-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.vozvrat.payments.terminal).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-cyan-50/60 dark:bg-cyan-950/30 rounded-lg border border-cyan-200/50 dark:border-cyan-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.vozvrat.payments.transfer).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                            ...
                                            {card.key === 'expense' && data?.expenses?.payments && (
                                                <>
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-green-50/60 dark:bg-green-950/30 rounded-lg border border-green-200/50 dark:border-green-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.expenses.payments.cash).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-purple-50/60 dark:bg-purple-950/30 rounded-lg border border-purple-200/50 dark:border-purple-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.expenses.payments.click).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-orange-50/60 dark:bg-orange-950/30 rounded-lg border border-orange-200/50 dark:border-orange-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.expenses.payments.terminal).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-cyan-50/60 dark:bg-cyan-950/30 rounded-lg border border-cyan-200/50 dark:border-cyan-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.expenses.payments.transfer).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                            ...
                                            {card.key === 'income' && data?.debt_repayments?.payments && (
                                                <>
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-green-50/60 dark:bg-green-950/30 rounded-lg border border-green-200/50 dark:border-green-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(data.debt_repayments.payments.cash).toLocaleString(
                                                                'en-US',
                                                                {
                                                                    minimumFractionDigits: 2,
                                                                    maximumFractionDigits: 2,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-purple-50/60 dark:bg-purple-950/30 rounded-lg border border-purple-200/50 dark:border-purple-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(
                                                                data.debt_repayments.payments.click,
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-orange-50/60 dark:bg-orange-950/30 rounded-lg border border-orange-200/50 dark:border-orange-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(
                                                                data.debt_repayments.payments.terminal,
                                                            ).toLocaleString('en-US', {
                                                                minimumFractionDigits: 2,
                                                                maximumFractionDigits: 2,
                                                            })}
                                                    ...
                                                    <div className='flex justify-between items-center p-2 bg-cyan-50/60 dark:bg-cyan-950/30 rounded-lg border border-cyan-200/50 dark:border-cyan-800/30'>
                                                        ...
                                                        <span className='font-semibold text-xs text-foreground'>
                                                            {safeNum(
                                                                data.debt_repayments.payments.transfer,
                                                            ).toLocaleString('en-US', {
                                                                minimumFractionDigits: 2,
                                                                maximumFractionDigits: 2,
                                                            })}
                        ...
                        {/* <div className='mt-4 flex justify-center'>
                            <button
                                ...
                                className='flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-all duration-200 shadow-md hover:shadow-lg font-medium text-xs'
                            >
                                {showFullSummary ? (
                                    <>
                                        <ChevronUp size={18} />
