					...
					<div key={product.name} className='space-y-2'>
						<div className='flex items-center justify-between gap-3'>
							<div className='flex items-center gap-2.5 min-w-0 flex-1'>
								<span className='flex h-7 w-7 lg:h-8 lg:w-8 items-center justify-center rounded-full bg-primary/10 text-xs lg:text-xs font-bold text-primary flex-shrink-0'>
									{index + 1}
								</span>
								<span className='text-xs lg:text-xs font-medium text-foreground truncate'>
									{product.name}
								</span>
							</div>
							<div className='text-right flex-shrink-0'>
								<p className='text-xs lg:text-xs font-bold text-foreground whitespace-nowrap'>
									{product.revenue}
								</p>
