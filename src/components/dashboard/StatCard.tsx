...
export function StatCard({ title, value, change, icon: Icon, iconColor, link }: StatCardProps) {
            ...
            <div className='flex items-start justify-between gap-3 pl-0.5'>
                <div className='flex items-start gap-3 min-w-0 flex-1'>
                    ...
                    <div className='flex-1 min-w-0 mt-0.5'>
                        <p className='text-xs lg:text-xs text-muted-foreground truncate font-medium'>{title}</p>
                        {/* Value */}
                        <p className='mt-1.5 text-xl lg:text-xl font-black tracking-tight text-foreground truncate'>
                            {value}
                        </p>
                    </div>
                </div>
