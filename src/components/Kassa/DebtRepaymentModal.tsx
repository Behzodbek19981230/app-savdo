    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className='sm:max-w-3xl max-h-[90vh] overflow-hidden'>
                <DialogHeader >
                    <DialogTitle className='flex items-center gap-2'>Qarz to'lash <div className='hidden sm:flex items-center gap-2 bg-white/60 px-2 py-1 rounded'>
                                        ...
                                        <FormControl>
                                            <Autocomplete
                                                ...
                                                onValueChange={(v) => {
                                                    ...
                                                    setValue('client', Number(v) || 0, { shouldDirty: true, shouldValidate: true });
                                                }}
                                ...
                                <div className='w-full'>
                                    ...
                                    <div className='px-2 py-1.5 bg-red-50 border border-red-200 rounded-lg mt-2'>
                                        <span className='text-sm font-bold text-red-700'>
                                            {selectedClient ? Number(selectedClient.total_debt || 0).toFixed(2) : '0.00'}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <DatePicker date={field.value} onDateChange={field.onChange} className='w-full [&>button]:h-8' />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <NumberInput value={field.value} onChange={(v) => field.onChange(v)} allowDecimal />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <NumberInput value={field.value} onChange={(v) => field.onChange(v)} allowDecimal disabled />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormItem className='flex items-center gap-3'>
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(v) => {
                                        ...
                                        setValue('debt_status', Boolean(v), { shouldDirty: true, shouldValidate: true });
                                    }}
                                />
                            </FormItem>
                        </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea rows={3} value={field.value} onChange={(e) => field.onChange(e.target.value)} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
