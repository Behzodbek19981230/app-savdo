...
export const API_ENDPOINTS = {
	...
	// Debt repayment endpoints (To'langan qarzlar)
	debtRepayment: {
		list: '/debt-repayment',
		listGroupedByDate: '/debt-repayment/grouped-by-date',
		byId: (id: string) => `/debt-repayment/${id}`,
		create: '/debt-repayment',
		update: (id: string) => `/debt-repayment/${id}`,
		delete: (id: string) => `/debt-repayment/${id}`,
	},
